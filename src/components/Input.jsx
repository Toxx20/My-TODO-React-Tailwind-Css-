 ...
 * @returns {JSX}
 */
export function Input({value,onChange,onSubmit,onKeyDown}){
    return <form className="checked--flex" onSubmit={onSubmit}>
        <input type="text"
                id="ka" 
                placeholder="Add new task" 
                className="roboto-bold text-[16px] placeholder:text-gray border-b border-amber-100 w-full h-12"
                value={value}
